...
describe TutorialsController do
  ...
  let(:valid_attributes) { { "tutorial_name" => "MyString", "tutorial_type" => "math", "category_id" => 1, "tutorial_date_release" => DateTime.now, "tutorial_discription" => "dsadsad", "tutorial_teacher_name" => "Teacher", "tutorial_path" => "dsadsad" } }
...
tutorial.category_id = 1
tutorial.tutorial_name = "dsadsa"
tutorial.tutorial_type = "math"
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Tutorial" do
        expect {
          post :create, {:tutorial => { "tutorial_name" => "MyString", "tutorial_type" => "math", "category_id" => 1, "tutorial_date_release" => DateTime.now, "tutorial_discription" => "dsadsad", "tutorial_teacher_name" => "Teacher", "tutorial_path" => "dsadsad" }}, valid_session
...
tutorial.tutorial_date_release = DateTime.now
tutorial.save
        put :update, {:id => tutorial.to_param, :tutorial => { "tutorial_name" => "MyString", "tutorial_type" => "math", "category_id" => 1, "tutorial_date_release" => DateTime.now, "tutorial_discription" => "dsadsad", "tutorial_teacher_name" => "Teacher", "tutorial_path" => "dsadsad" }}, valid_session
        assigns(:tutorial).should eq(tutorial)
      end
